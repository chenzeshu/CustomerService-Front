<template>
  <div class="info2">
    <div class="info2-plus" @click="_toggleCreate">
      <Icon type="plus-circled"></Icon>
    </div>

    <div class="info2-search">
        <span class="search-icon">
          <Icon type="search"></Icon>
        </span>
      <input type="text" v-model.trim="searchWord" placeholder="站类型名称" class="search">
    </div>
    ...
    <Modal
      ...
      <Form :model="createModel" :rules="ruleValidate" ref="createForm" :label-width="80">
        <FormItem label="站类型名称" prop="name">
  ...
  export default {
    ...
    data(){
      return {
        ...
        ruleValidate:{
          name: [
            {required: true, message: '站类型名称不能为空', trigger: 'blur' }
          ]
        }
      }
    },
