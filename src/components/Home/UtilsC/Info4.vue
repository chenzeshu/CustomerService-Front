<template>
  <div class="info4">
    <div class="info4-plus" @click="_toggleCreate">
      <Icon type="plus-circled"></Icon>
    </div>

    <div class="info4-search">
        <span class="search-icon">
          <Icon type="search"></Icon>
        </span>
      <input type="text" v-model.trim="searchWord" placeholder="频率名称" class="search">
    </div>
  ...
  export default {
    ...
    data(){
      return {
        ...
        ruleValidate:{
          name: [
            {required: true, message: '频率名称不能为空', trigger: 'blur' }
          ]
        }
      }
    },
