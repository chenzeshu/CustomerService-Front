<template>
  <div class="info6">
    <div class="info6-plus" @click="_toggleCreate">
      <Icon type="plus-circled"></Icon>
    </div>

    <div class="info6-search">
        <span class="search-icon">
          <Icon type="search"></Icon>
        </span>
      <input type="text" v-model.trim="searchWord" placeholder="网络类型名称" class="search">
    </div>
    ...
    <Modal
      ...
      <Form :model="createModel" :rules="ruleValidate" ref="createForm" :label-width="80">
        <FormItem label="网络类型名称" prop="name">
  ...
  export default {
    ...
    data(){
      return {
        ...
        ruleValidate:{
          name: [
            {required: true, message: '网络类型名称不能为空', trigger: 'blur' }
          ]
        }
      }
    },
