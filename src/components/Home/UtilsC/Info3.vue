<template>
  <div class="info3">
    <div class="info3-plus" @click="_toggleCreate">
      <Icon type="plus-circled"></Icon>
    </div>

    <div class="info3-search">
        <span class="search-icon">
          <Icon type="search"></Icon>
        </span>
      <input type="text" v-model.trim="searchWord" placeholder="通信卫星名称" class="search">
    </div>
    ...
    <Modal
      ...
      <Form :model="createModel" :rules="ruleValidate" ref="createForm" :label-width="80">
        <FormItem label="通信卫星名称" prop="name">
  ...
  export default {
    ...
    data(){
      return {
        ...
        ruleValidate:{
          name: [
            {required: true, message: '通信卫星名称不能为空', trigger: 'blur' }
          ]
        }
      }
    },
