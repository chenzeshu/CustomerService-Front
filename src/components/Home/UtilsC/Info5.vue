<template>
  <div class="info5">
    <div class="info5-plus" @click="_toggleCreate">
      <Icon type="plus-circled"></Icon>
    </div>

    <div class="info5-search">
        <span class="search-icon">
          <Icon type="search"></Icon>
        </span>
      <input type="text" v-model.trim="searchWord" placeholder="极化名称" class="search">
    </div>
  ...
  export default {
    ...
    data(){
      return {
        ...
        ruleValidate:{
          name: [
            {required: true, message: '极化名称不能为空', trigger: 'blur' }
          ]
        }
      }
    },
